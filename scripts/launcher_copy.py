...
class launcher:
    ...
    def build(self, target_config):
        ...
        cmd = f'/home/satoshi/.local/bin/meson builddir --reconfig --buildtype release '\
        ...
        for th_num in target_config['thread_num']:
            ...
            for testee in testees:
                ...
                if testee in ['steph', 'clevel'] and th_num == 48:
                    tmp_th_num = 47
                cmd = f'LD_LIBRARY_PATH=/home/satoshi/mnt/kssd/tools/fmt-8.1.1/build numactl -N0 ./builddir/pmhb -w /mnt/pmem0/Testee/ -o {data_path} '\
                    f'-l /home/satoshi/mnt/kssd/workloads/SEPH/scripts/Trace_AE/load/{target_config["workload"]}.ycsb '\
                    f'-r /home/satoshi/mnt/kssd/workloads/SEPH/scripts/Trace_AE/run/{target_config["workload"]}.ycsb '\
