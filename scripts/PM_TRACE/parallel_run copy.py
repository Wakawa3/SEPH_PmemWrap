...
profiles += ['workload_load_big', 'workloada_big', 'workloadb_big',
            ...
            # 'workloadc_big', 'workloadf_big']
for profile in profiles:
    cmd_instance = f"{cmd} /home/satoshi/mnt/kssd/workloads/SEPH/scripts/Trace_AE/load/{profile}.ycsb /home/satoshi/mnt/kssd/workloads/SEPH/scripts/Trace_AE/run/{profile}.ycsb /mnt/pmem0/Trace/{profile} > logs/{profile}.log &"
    print(cmd_instance)
