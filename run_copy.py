...
if sys.argv[1] in ['launch_all', 'check', 'complete']:
    ...
    os.system(
        ...
        f'-l /home/satoshi/mnt/kssd/workloads/SEPH/scripts/Trace_AE/load/{trace}.ycsb '
        f'-r /home/satoshi/mnt/kssd/workloads/SEPH/scripts/Trace_AE/run/{trace}.ycsb '
...
f"./builddir/pmhb -w /mnt/pmem0/Testee/ -o ./data/tmp -l /home/satoshi/mnt/kssd/workloads/SEPH/scripts/Trace_AE/load/workload_load.ycsb -r /home/satoshi/mnt/kssd/workloads/SEPH/scripts/Trace_AE/run/workload_load.ycsb -m /mnt/pmem0/Trace/workload_load --load_num 10000000 --run_num 20000000 -e speth -t 47"
